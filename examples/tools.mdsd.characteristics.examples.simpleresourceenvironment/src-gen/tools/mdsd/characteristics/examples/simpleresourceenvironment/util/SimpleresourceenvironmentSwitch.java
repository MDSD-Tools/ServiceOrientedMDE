 ...
 * @generated
 */
public class SimpleresourceenvironmentSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public SimpleresourceenvironmentSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SimpleresourceenvironmentPackage.RESOURCE_CONTAINER: {
			...
			if (result == null)
				result = caseCharacterizable(resourceContainer);
			if (result == null)
		...
		case SimpleresourceenvironmentPackage.RESOURCE: {
			...
			if (result == null)
				result = caseCharacterizable(resource);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SimpleresourceenvironmentPackage.PROCESSING_RESOURCE: {
			...
			if (result == null)
				result = caseCharacterizable(processingResource);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
...
} //SimpleresourceenvironmentSwitch
