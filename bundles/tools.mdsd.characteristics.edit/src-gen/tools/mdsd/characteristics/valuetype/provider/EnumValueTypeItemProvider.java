...
/**
 * This is the item provider adapter for a {@link tools.mdsd.characteristics.valuetype.EnumValueType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumValueTypeItemProvider extends BaseValueTypeItemProvider
{
	...
	{
		String label = ((EnumValueType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EnumValueType_type") :
			getString("_UI_EnumValueType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		{
			case ValuetypePackage.ENUM_VALUE_TYPE__EXPLICIT_VALUES:
