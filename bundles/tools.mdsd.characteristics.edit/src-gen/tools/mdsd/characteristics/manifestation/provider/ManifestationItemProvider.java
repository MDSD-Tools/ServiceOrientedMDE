 ...
 * @generated
 */
public class ManifestationItemProvider extends IdentifierItemProvider
{
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Manifestation_valuetype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Manifestation_valuetype_feature", "_UI_Manifestation_type"),
				 ManifestationPackage.Literals.MANIFESTATION__VALUETYPE,
				 true,
				 false,
				 true,
				 null,
	...
	{
		String label = ((Manifestation)object).getId();
